...
async def give_gift(chat_id):
    # Текст для тех, кто уже с нами
    welcome_back = (
        "Рад видеть вас снова! Ваша подписка активна.\n\n"
        "Я Александр Лазаренко, психолог МПТ. Помогаю вернуть себе роль Автора своей реальности.\n\n"
        "🎁 **Ваш подарок:** полный тест «Свобода быть собой» в формате PDF (отправляю ниже).\n\n"
        "Также предлагаю пройти экспресс-квиз, чтобы определить ваш текущий уровень авторства."
    )
